<template>
  <main
    class="d-flex flex-column justifty-content-center align-items-center bg-dark"
  >
    <div class="container">
        ...
        <div class="col col-md-6">
          ...
          <div class="grid">
            <div
              ...
              class="card card-body box justifty-content-center align-items-center bg-light"
            >
      ...
      <div class="text-center mt-3">
        <button class="btn btn-danger btn-block px-5" v-on:click="reloadGame">
          Reset Game
        </button>
      </div>
    </div>
